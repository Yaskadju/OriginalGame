package me.yaska.Entity.Enemies;
...
import me.yaska.Entity.Animation;
...
public class Slugger extends Enemy {
	...
	public void draw(Graphics2D g) {
		...
		//if(notOnScreen()) return; // if it is true, enemy is not on screen, so don't do anything, just return
